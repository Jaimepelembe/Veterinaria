...
public class Cadastro_Vacina implements ActionListener, DateChooserListener {
    ...
    private String[] VacinasCaes = { "Polivalente (V10) ", "Antirrábica", "Gripe", "Giárdia", "Esgana",
            "Parvovirose " };
    private String[] VacinasGatos = { "Panleucopénia", "Antirrábica ", "RinoTranquete", "Leucemia",
            "Peritonite infeciosa ", "Clamídia" };
    ...
    private void inicializarComponentes() {
        ...
        // Cores para Botoes Salvar e limpar
        ...
        bCancelar.setBackground(corLimpar);
    ...
    public Container botoesCadastro() {
    ...
    // Metodo para devolver o painel de cadastro com todos componentes e botoes
    // inseridos
